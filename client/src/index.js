    ...
    return(
        ...
        <Navbar signedIn={this.state.signedIn} signOut={this.signOut} signIn={this.signIn} signUp={this.signUp} />
            <div style={{marginTop: "25px"}}>
                ...
                <Route path="/dashboard" component={() => <Dashboard currentUser={this.state.user} signedIn={this.state.signedIn}/>}/>
                ...
                <Route path="/create" component={() => <NewEvent currentUser={this.state.user} signedIn={this.state.signedIn}/>} />
            </div>
        </Router>
        </div>
    )
